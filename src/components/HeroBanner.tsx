...
export default function HeroBanner({title}: { title: string }) {
    return (
        <div className="relative h-[180px] w-full overflow-hidden">
            ...
            <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 flex flex-col justify-center">
                <div>
                    <h2 className="text-4xl font-medium text-white">
                        {title}
                    </h2>
                    <Link href="/" className="mt-2 inline-block text-md text-white hover:underline">
                        Home
                    </Link>
                </div>
            </div>
